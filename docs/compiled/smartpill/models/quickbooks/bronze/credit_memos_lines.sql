...
from "datawarehouse".prod_quickbooks."credit_memos"
...
where
    ...
    and _airbyte_emitted_at > (select max(_airbyte_emitted_at) from "datawarehouse".prod_quickbooks."credit_memos_lines")
