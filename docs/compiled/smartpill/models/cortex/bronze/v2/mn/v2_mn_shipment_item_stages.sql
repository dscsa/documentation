with q as (
    ...
    from "datawarehouse"."raw"._airbyte_raw_cortex_v2_mn_shipment_item_stages
    
        where _airbyte_emitted_at > (select COALESCE(max(_airbyte_emitted_at), '2024-01-01') from "datawarehouse".cortex."v2_mn_shipment_item_stages")
