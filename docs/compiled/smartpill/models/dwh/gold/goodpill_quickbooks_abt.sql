...
select
    ...
    item_unit_price_retail_initial,
    item_unit_price_goodrx_initial,
    item_unit_price_nadac_initial,
    item_unit_price_awp_initial,
    ...
    order_payment_default_updated_at,
    order_payment_actual_updated_at,
